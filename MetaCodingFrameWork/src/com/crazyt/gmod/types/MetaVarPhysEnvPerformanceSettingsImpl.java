...
public class MetaVarPhysEnvPerformanceSettingsImpl extends MetaVarImpl implements MetaVarPhysEnvPerformanceSettings{
	...
	public MetaVarPhysEnvPerformanceSettingsImpl(String n) {
		super(n);
	}
}
